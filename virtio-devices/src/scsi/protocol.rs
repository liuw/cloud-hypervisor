...
pub const VIRTIO_SCSI_EVT_ASYNC_SUPPORTED: u32 = VIRTIO_SCSI_EVT_ASYNC_OPERATIONAL_CHANGE
    | VIRTIO_SCSI_EVT_ASYNC_POWER_MGMT
    | VIRTIO_SCSI_EVT_ASYNC_EXTERNAL_REQUEST
    | VIRTIO_SCSI_EVT_ASYNC_MEDIA_CHANGE
    | VIRTIO_SCSI_EVT_ASYNC_MULTI_HOST
